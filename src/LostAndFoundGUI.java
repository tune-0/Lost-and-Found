...
public class LostAndFoundGUI extends JFrame {
    ...
    private void initComponents() {
        ...
        btnRefresh.setBackground(new Color(169, 223, 191));
        ...
        // Table
        String[] columns = {"Item ID", "Item Name", "Date Found", "Status"};
        ...
        btnUpdate.setBackground(new Color(239, 188, 102));
        ...
        btnDelete.setBackground(new Color(222, 54, 31));
        ...
        btnClear.setBackground(new Color(210, 218, 226));
    ...
    private void addActionListeners() {
        ...
        btnAdd.addActionListener(e -> {
            ...
            try {
                ...
                System.out.println("Error opening dialog: " + ex.getMessage());
                ex.printStackTrace();
            }
        });
        ...
        // Refresh button
        btnRefresh.addActionListener(e -> loadAllItems());
    ...
    private void loadSelectedItem(int row) {
        ...
        Date dateFound = (Date) tableModel.getValueAt(row, 2);
    ...
    private void addItem() {
        ...
        // Add functionality now handled by AddItemDialog
    }
    ...
    private void updateItem() {
        if (validateForm() && selectedItemId != -1) {
            ...
            Item item = new Item(selectedItemId, itemName, dateFound, status);
